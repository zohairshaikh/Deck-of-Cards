	...
	var DeckOfCards = function (_React$Component) {
	    ...
	    _createClass(DeckOfCards, [{
	        ...
	        value: function restart() {
	            ...
	            var el = (0, _reactDom.findDOMNode)(this.refs.cardsContainer).innerHTML = '';
	            console.log(el);
	            this.setState({
	                reset: true,
	                deck: []
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'child-70', ref: 'cardsContainer', id: 'cards-container', onDrop: this.drop, onDragOver: this.allowDrop },
...
//# sourceMappingURL=0.44d888b3825bfaf29a0f.hot-update.js.map