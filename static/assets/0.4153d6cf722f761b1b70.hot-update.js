	...
	var DeckOfCards = function (_React$Component) {
	    ...
	    _createClass(DeckOfCards, [{
	        ...
	        value: function drop(ev) {
	            ...
	            var dropVal = document.getElementById(data + ':val');
	            console.log('dropVal', dropVal.innerHTML);
	    ...
	    _createClass(Card, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'p',
	                    { id: this.props.indexId + ':val', value: this.state.suite_name, style: { display: 'none' } },
...
//# sourceMappingURL=0.4153d6cf722f761b1b70.hot-update.js.map