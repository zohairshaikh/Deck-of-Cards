	...
	var DeckOfCards = function (_React$Component) {
	    ...
	    _createClass(DeckOfCards, [{
	        ...
	        value: function returnCards(data, itr) {
	            var card = _react2.default.createElement(_Card2.default, { onDragStart: this.onDragStart, value: data });
	            return card;
	        }
	    }, {
	...
	var Card = function (_React$Component) {
	    ...
	    _createClass(Card, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { draggable: 'true', onDragStart: props.onDragStart, className: 'card-container', style: { 'color': this.state.color } },
	                _react2.default.createElement(
	                    'p',
...
//# sourceMappingURL=0.9c9cf68c73c7404fa697.hot-update.js.map