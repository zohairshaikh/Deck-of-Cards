...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeckOfCards = function (_React$Component) {
	    ...
	    _createClass(DeckOfCards, [{
	        ...
	        key: 'saveProgress',
	        value: function saveProgress(cardsarr) {
	            $.ajax({
	                'url': '/saveProgress/',
	                'data': { 'username': this.state.username, 'data': JSON.stringify(cardsarr) },
	                'type': 'POST',
	            ...
	            $.ajax({
	                ...
	                success: function (resp) {
	                    ...
	                    if (resp.isNew == 1) {
	                        ...
	                        deck = utils.getSavedDeck(resp.userdata);
	                        console.log('saved deck', JSON.parse(resp.userdata));
	                    }
	                    this.setState({
	                        deck: deck,
	                        loggedIn: true,
...
//# sourceMappingURL=0.94c2d8519f1b96f71b45.hot-update.js.map