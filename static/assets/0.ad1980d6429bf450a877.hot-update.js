	...
	var DeckOfCards = function (_React$Component) {
	    ...
	    _createClass(DeckOfCards, [{
	        ...
	        value: function shuffle() {
	            ...
	            innerDiv.id = 'cards-container-inner';
	            for (var i = 0; i < deck.length; i++) {
	                var card = this.returnCards(deck[i], i);
	                console.log('aa', card);
	                innerDiv.appendChild(_reactDom2.default.findDOMNode(_react2.default.createElement(_Card2.default, null)));
	            }
	            document.getElementById('cards-container').appendChild(innerDiv);
...
//# sourceMappingURL=0.ad1980d6429bf450a877.hot-update.js.map